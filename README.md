...
基于 hezdaaa 的千恋万花小米手环 9 Pro 源码修改优化，适配小米手环 9。
...
于是我针对小米手环 9 做了专门的移植适配，优化了界面和交互，让没有 Pro 系列手环的朋友也能玩上这款游戏。

开源出来，供没有 Pro 系列手环的人游玩使用。

## 安装方法

1. 下载本项目的 .rpk 文件（包体大小约 14MB）
2. 通过表盘自定义或 astrobox 等工具安装到手环
3. 由于包体较大，安装速度较慢，安装不上可以多试几次，或者重启再试，请理解
4. 首次启动会有操作提示
